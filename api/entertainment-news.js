const CATEGORIES = {
  ...
  other: {
    label: "其他",
    query: '(J-pop OR 日本藝人 OR 日本歌手 OR 泰國藝人 OR 泰國歌手 OR 亞洲娛樂)'
  }
};
...
export default async function handler(req, res) {
  ...
  try {
    const response = await fetch(feedUrl, {
      headers: { "User-Agent": "Mozilla/5.0 NEUL/0.40.2", "Accept": "application/rss+xml, application/xml, text/xml;q=0.9,*/*;q=0.5" },
