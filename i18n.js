(() => {
  ...
  const D = {
    en: {
      '演藝新聞':'Entertainment News','即時整理近期演藝動態，可依區域切換或搜尋關鍵字。':'Recent entertainment updates, filterable by region or keyword.','重新整理新聞':'Refresh news','演藝新聞分類':'Entertainment news categories','韓星':'Korean','台灣':'Taiwan','歐美':'US / Europe','搜尋演藝新聞關鍵字':'Search entertainment news','搜尋演藝新聞':'Search entertainment news','正在更新韓星新聞…':'Updating Korean entertainment news…','新聞標題、時間與來源由公開新聞索引整理；內容與後續更正仍以原始媒體頁面為準。':'Headlines, times and sources are aggregated from public news indexes. Article content and corrections remain subject to the original publisher.',
    ...
    ja: {
      '演藝新聞':'エンタメニュース','即時整理近期演藝動態，可依區域切換或搜尋關鍵字。':'最近のエンタメニュースを地域やキーワードで絞り込めます。','重新整理新聞':'ニュースを更新','演藝新聞分類':'エンタメニュース分類','韓星':'韓国','台灣':'台湾','歐美':'欧米','搜尋演藝新聞關鍵字':'エンタメニュースを検索','搜尋演藝新聞':'エンタメニュースを検索','正在更新韓星新聞…':'韓国エンタメニュースを更新中…','新聞標題、時間與來源由公開新聞索引整理；內容與後續更正仍以原始媒體頁面為準。':'見出し、時刻、出典は公開ニュース索引から整理しています。内容と訂正は元媒体をご確認ください。',
    ...
    ko: {
      '演藝新聞':'연예 뉴스','即時整理近期演藝動態，可依區域切換或搜尋關鍵字。':'최근 연예 소식을 지역이나 키워드로 찾아볼 수 있습니다.','重新整理新聞':'뉴스 새로고침','演藝新聞分類':'연예 뉴스 카테고리','韓星':'한국','台灣':'대만','歐美':'미주/유럽','搜尋演藝新聞關鍵字':'연예 뉴스 검색','搜尋演藝新聞':'연예 뉴스 검색','正在更新韓星新聞…':'한국 연예 뉴스 업데이트 중…','新聞標題、時間與來源由公開新聞索引整理；內容與後續更正仍以原始媒體頁面為準。':'제목, 시간, 출처는 공개 뉴스 색인에서 정리합니다. 기사 내용과 정정은 원문 매체를 확인해 주세요.',
