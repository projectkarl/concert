...
const CITY_RULES = [
  [/桃園|林口|NTSU/i,"Taoyuan"],[/高雄|Kaohsiung/i,"Kaohsiung"],[/台中|臺中|Taichung/i,"Taichung"],[/台南|臺南|Tainan/i,"Tainan"],[/新北|New Taipei/i,"New Taipei"],[/新竹/i,"Hsinchu"],[/基隆/i,"Keelung"],[/嘉義/i,"Chiayi"],[/彰化/i,"Changhua"],[/屏東/i,"Pingtung"],[/宜蘭/i,"Yilan"],[/花蓮/i,"Hualien"],[/台東|臺東/i,"Taitung"],[/台北|臺北|Taipei|Legacy TERA/i,"Taipei"]
];
const PLATFORM_INDEXES = [
  {name:"tixCraft 拓元",url:"https://tixcraft.com/activity",indexes:["https://tixcraft.com/activity","https://tixcraft.com/activity/d","https://tixcraft.com/activity/de","https://tixcraft.com/activity/deta"],detail:/https?:\/\/tixcraft\.com\/activity\/detail\/[A-Za-z0-9_-]+/gi,maxDetails:96},
  ...
  {name:"Ticket Plus 遠大售票",url:"https://ticketplus.com.tw/activity",indexes:["https://ticketplus.com.tw/activity"],detail:/https?:\/\/ticketplus\.com\.tw\/activity\/[A-Za-z0-9_-]+/gi,maxDetails:64},
  ...
  {name:"FANSI GO",url:"https://go.fansi.me/events",indexes:["https://go.fansi.me/events"],detail:/https?:\/\/go\.fansi\.me\/(?:events\/\d+|tickets\/show\/\d+)/gi,maxDetails:36},
  {name:"iNDIEVOX",url:"https://www.indievox.com/activity/latest?type=table",indexes:["https://www.indievox.com/activity/latest?type=table","https://www.indievox.com/activity/latest?type=card"],detail:/https?:\/\/(?:www\.)?indievox\.com\/activity\/detail\/[A-Za-z0-9_-]+/gi,maxDetails:48},
...
export async function discoverTaiwanTicketPlatforms(){
  ...
  return{events,checkedUrls,indexErrors,pageErrors,source:"tixCraft + KKTIX + Ticket Plus + 寬宏 + FamiTicket + udn + ibon + MNA + 年代 + TixFun + OPENTIX + FANSI GO + iNDIEVOX + 博客來",sourceHealth:PLATFORM_INDEXES.map(p=>({name:p.name,indexCount:(p.indexes||[p.url]).length,detailCap:p.maxDetails||24,discovered:[...(urlsByPlatform.get(p.name)||[])].length}))};
}
