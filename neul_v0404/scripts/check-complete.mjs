...
const futureOfficialVenue=ensureVenueModelForEvent(futureOfficial),futureOfficialLayoutId=ensureAutoEventLayout(futureOfficial),futureOfficialLayout=getVenueLayout(futureOfficialLayoutId);
if(!futureOfficialVenue?.startsWith('runtime-')||!futureOfficialLayout?.autoGenerated||futureOfficialLayout.eventId!==futureOfficial.id||!futureOfficialLayout.stage?.main) fail('official-map opt-in provisional 3D failed',{futureOfficialVenue,futureOfficialLayoutId});
