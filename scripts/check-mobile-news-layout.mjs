...
if(!/(?:news-mobile-fix1|v0\.40\.15-auto-coverage-seatmap-recovery|v0\.40\.16-twcv-reference-queue)/.test(sw)){console.error('FAIL service-worker cache does not include mobile News fix or newer release');ok=false;}
