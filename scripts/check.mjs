...
if (!/\/i18n\.js/.test(sw) || !/neul-v0\.40\.(?:2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar|ux1-calendar-seat3d|ux2-entertainment-news|ux3-news-venue-policy-officialmap)|3-venue-topology-guard|4-coverage-precision-mobile|5-kstar-reference-source-trace|6-mainstream10-news-bottom-official-map|7-mainstream12-news-bottom-official-map|8-aespa-official-seatmap|9-full-concert-coverage|10-3dprecision-nonregression|11-officialmap-cdn-fix|13-verified316-recentdata|14-venue-calibration-verified316|15-auto-coverage-seatmap-recovery|16-twcv-reference-queue)/.test(sw)) { console.error("PWA multilingual cache update missing"); ok=false; }
...
if (!/neul-v0\.40\.(?:2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar|ux1-calendar-seat3d|ux2-entertainment-news|ux3-news-venue-policy-officialmap)|3-venue-topology-guard|4-coverage-precision-mobile|5-kstar-reference-source-trace|6-mainstream10-news-bottom-official-map|7-mainstream12-news-bottom-official-map|8-aespa-official-seatmap|9-full-concert-coverage|10-3dprecision-nonregression|11-officialmap-cdn-fix|13-verified316-recentdata|14-venue-calibration-verified316|15-auto-coverage-seatmap-recovery|16-twcv-reference-queue)/.test(sw) || !/seat-map-intelligence\.js/.test(sw)) { console.error("v0.40 service-worker cache regression"); ok=false; }
