...
if (!/\/i18n\.js/.test(sw) || !/neul-v0\.40\.(?:2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar|ux1-calendar-seat3d|ux2-entertainment-news|ux3-news-venue-policy-officialmap)|3-venue-topology-guard|4-coverage-precision-mobile|5-kstar-reference-source-trace|6-mainstream10-news-bottom-official-map)/.test(sw)) { console.error("PWA multilingual cache update missing"); ok=false; }
...
if (!/neul-v0\.40\.(?:2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar|ux1-calendar-seat3d|ux2-entertainment-news|ux3-news-venue-policy-officialmap)|3-venue-topology-guard|4-coverage-precision-mobile|5-kstar-reference-source-trace|6-mainstream10-news-bottom-official-map)/.test(sw) || !/seat-map-intelligence\.js/.test(sw)) { console.error("v0.40 service-worker cache regression"); ok=false; }
