...
if (!/taipei-music-center/.test(app) || !/kaohsiung-national-stadium/.test(app) || !/tianmu-gymnasium/.test(app)) { console.error("external real-view venue links missing"); ok=false; }
