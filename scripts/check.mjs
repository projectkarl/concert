...
if (!/\/i18n\.js/.test(sw) || !/neul-v0\.40\.2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar)/.test(sw)) { console.error("PWA multilingual cache update missing"); ok=false; }
...
if (!/neul-v0\.40\.2-(?:full-coverage-auditor|complete(?:2)?-auto3d-calendar)/.test(sw) || !/seat-map-intelligence\.js/.test(sw)) { console.error("v0.40 service-worker cache regression"); ok=false; }
